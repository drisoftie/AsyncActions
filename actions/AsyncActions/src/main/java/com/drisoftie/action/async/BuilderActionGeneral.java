 ...
 */
public class BuilderActionGeneral<ViewT> {
     ...
     */
    @SafeVarargs
    public final TargetBuilder with(ViewT... views) {
    ...
    public class TargetBuilder {
        ...
        /**
         * Setting a registration with {@link Pair}s of multiple handler classes paired with the given
         * methods.
         *
