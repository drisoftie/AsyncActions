 ...
 * derived {@link View} (generic {@link ViewT} argument) and wraps them inside a generic three-step process.
 * <ol>
 ...
 */
public abstract class ActionGeneral<ViewT, ResultT, ProgressT, Tag1T, Tag2T>
        extends BaseAsyncAction<ViewT, ResultT, ProgressT, Tag1T, Tag2T> {

    /**
     * @see BaseAsyncAction#BaseAsyncAction(Object, Object, Object...)
     */
    public ActionGeneral(Tag1T tag1, Tag2T tag2, Object... additionalTags) {
        super(tag1, tag2, additionalTags);
    }

    /**
     * @see BaseAsyncAction#BaseAsyncAction(Object, Class, String)
     */
    public ActionGeneral(ViewT view, Class<?> actionType, String regMethodName) {
     ...
     * @see BaseAsyncAction#BaseAsyncAction(Object[], Class, String)
     */
    public ActionGeneral(ViewT[] views, Class<?> actionType, String regMethodName) {
     ...
     * @see BaseAsyncAction#BaseAsyncAction(Object, Class[], String)
     */
    public ActionGeneral(ViewT view, Class<?>[] actionTypes, String regMethodName) {
     ...
     * @see BaseAsyncAction#BaseAsyncAction(Object[], Class[], String)
     */
    public ActionGeneral(ViewT[] views, Class<?>[] actionTypes, String regMethodName) {
        super(views, actionTypes, regMethodName);
    }

    /**
     * @see BaseAsyncAction#BaseAsyncAction(Object, Class, String, String[])
     */
    public ActionGeneral(ViewT view, Class<?> actionTypes, String regMethodName, String[] actionMethodNames) {
     ...
     * @see BaseAsyncAction#BaseAsyncAction(Object[], Class, String, String[])
     */
    public ActionGeneral(ViewT[] views, Class<?> actionTypes, String regMethodName, String[] actionMethodNames) {
    ...
    /**
     * @see BaseAsyncAction#BaseAsyncAction(Object, Class, String, String[], Object, Object,
     * Object...)
     */
    public ActionGeneral(ViewT view, Class<?> actionType, String regMethodName, String[] actionMethodNames, Tag1T tag1, Tag2T tag2,
                         Object... additionalTags) {
     ...
     * Object...)
     */
    public ActionGeneral(ViewT[] views, Class<?> actionType, String regMethodName, String[] actionMethodNames, Tag1T tag1, Tag2T tag2,
                         Object... additionalTags) {
     ...
     * Object...)
     */
    public ActionGeneral(ViewT view, Class<?>[] actionTypes, String regMethodName, String[] actionMethodNames, Tag1T tag1, Tag2T tag2,
                         Object... additionalTags) {
     ...
     * Object...)
     */
    public ActionGeneral(ViewT[] views, Class<?>[] actionTypes, String regMethodName, String[] actionMethodNames, Tag1T tag1, Tag2T tag2,
                         Object... additionalTags) {
